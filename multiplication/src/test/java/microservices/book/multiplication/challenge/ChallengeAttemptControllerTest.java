...
public class ChallengeAttemptControllerTest {
    ...
    void postValidResult() throws Exception {
        ...
        //when
        MockHttpServletResponse response = mvc.perform(post("/attempts").contentType(MediaType.APPLICATION_JSON).content(jsonRequestAttempt.write(attemptDTO).getJson())).andReturn().getResponse();
